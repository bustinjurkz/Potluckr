    ...
    public static ArrayList<String[]> DatetoArrayString(String[] month) {
        ...
        while (i < overlap_dates.size()) {
            ...
            if (s.getCalendar_s().get(Calendar.DAY_OF_YEAR) == d.getCalendar_s().get(Calendar.DAY_OF_YEAR)) {
                temp[0] = "" + month[(s.getMonth()-1)].substring(0, 1).toUpperCase() + month[(s.getMonth()-1)].substring(1) + " " + s.getDay() + " " + s.getYear();
                //System.out.println(temp[0]);
                temp[1] = "" + "<br />" + "&emsp;&emsp;" + time_toString(s.getS_hour()) + ':' + time_toString(s.getS_min()) + " to " + time_toString(s.getE_hour()) + ':' + time_toString(s.getE_min());
                //System.out.println(temp[1]);
                while((s.getCalendar_s().get(Calendar.DAY_OF_YEAR) == d.getCalendar_s().get(Calendar.DAY_OF_YEAR)) && (i < overlap_dates.size())) {
                    temp[1] = temp[1] + "<br />" + "&emsp;&emsp;" + time_toString(d.getS_hour()) + ':' + time_toString(d.getS_min()) + " to " + time_toString(d.getE_hour()) + ':' + time_toString(d.getE_min());
                    //System.out.println(temp[1]);
