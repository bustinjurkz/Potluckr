	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			match(EOF);
			    ...
			    _localctx.myOutput.writeFile(rescipeArr, recipeDict, csvDict);

			    _localctx.str += PeopleContainer.PeopleList.get(0).getName() + "\n";
			    //_localctx.str += PeopleContainer.PeopleList.get(0).getAllergy().get(0) + "\n";
			    _localctx.str += PeopleContainer.PeopleList.get(0).getDiet() + "\n";
			    //_localctx.str += PeopleContainer.PeopleList.get(0).getAvailable(monthStr[PeopleContainer.PeopleList.get(0).getAvailable().get(0).getMonth()]-1).toString() + "\n";

			    System.out.println(_localctx.str);
	...
	public final AllergyContext allergy() throws RecognitionException {
		...
		try {
			...
			match(T__1);
			    ...
			    if(!inRecipe){
			        PeopleContainer.getPeopleList().get(index).addAllergy(_localctx.aller);
			    }
